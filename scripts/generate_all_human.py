...
def parse_args():
    ...
    parser.add_argument("--ckpt_path", 
                        type=str, 
                        default="/n/groups/marks/users/erik/Promoter_Poet_private/model/single_0.3_human_big_greedy_0.2_dropout_epoch=11.ckpt")
...
def main():
    ...
    df.to_csv("data/single_seq_16k_context_big_greedy_mid_temp_generated_promoters.csv")
    print("-------finished-------")
